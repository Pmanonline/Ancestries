  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-12">
        {/* Heading */}
        <h1 className="text-center text-4xl font-bold text-green-700 mb-12">
          About E-ANCESTRY
        </h1>

        {/* Main Content */}
        <div className="flex flex-col lg:flex-row items-center mb-16 bg-white rounded-lg shadow-md overflow-hidden">
          {/* Text Content */}
          <div className="lg:w-3/5 p-8">
            ...
            <p className="text-gray-700">
              Your family's history is full of untold stories and hidden
              connections. We help you to uncover new details, and deepen your
              understanding of your heritage. Sign up today and take the next
              step in uncovering the rich tapestry of your family's past.
            </p>
          ...
          <div className="lg:w-1/2 bg-white rounded-lg shadow-md p-8">
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                <p className="text-gray-700">
                  Our platform connects you with other family researchers,
                  provides personalized support, and offers educational
                  resources.
                </p>
              </li>
            </ul>
          ...
          <div className="lg:w-1/2 bg-white rounded-lg shadow-md p-8">
            ...
            <ul className="space-y-4">
              <li>
                ...
                <p className="text-gray-700">
                  Access a wide range of resources, including historical
                  records, databases, and search features.
                </p>
              </li>
              <li>
                <h3 className="font-semibold text-green-500">
              ...
              <li>
                ...
                <p className="text-gray-700">
                  Explore our collection of articles, webinars, and guides to
                  learn more about genealogy research techniques.
                </p>
              </li>
              <li>
                <h3 className="font-semibold text-green-500">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-700">
                We are dedicated to providing accurate and reliable information,
                meticulously verifying sources and cross-referencing data.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-green-500 mb-2">
              ...
              <p className="text-gray-700">
                Your satisfaction is our priority. We strive to offer a
                user-friendly experience and responsive support.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-green-500 mb-2">
              ...
              <p className="text-gray-700">
                We help you connect with your past, appreciate your cultural
                roots, and pass down your family's legacy.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16">
          ...
          <img
            src={AboutImageTree2}
            alt="Family Tree"
            className="w-1/2 h-auto mx-auto md:hidden"
          />
        </div>

        {/* Call to Action */}
        <div className="bg-green-600 text-black rounded-lg shadow-md p-8 mt-16 text-center">
          <h3 className="text-2xl font-semibold mb-4">
            Join Us in Discovering Your Family's History
          </h3>
          <p className="mb-6">
            At E-ANCESTRY, we are excited to be part of your journey to uncover
            your family's past. Sign up today and start exploring the rich
            tapestry of your ancestry. Together, let's preserve and celebrate
            your heritage.
          </p>
          <button className="bg-white text-green-600 font-semibold py-2 px-6 rounded-full hover:bg-green-100 transition duration-300">
            Get Started
          </button>
        </div>
      </div>
