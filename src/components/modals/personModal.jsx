...
//       dispatch(fetchAllDetails(userId)); // Ensure userId is correctly passed
//     }
//   }, [Esuccess, dispatch, userId]); // Adding userId to dependency array
...
// export const NestedModal = React.forwardRef(({ userId }, ref) => {
...
//                             initialState={personData}
//                             onSubmit={(data) => {
//                               dispatch(fetchAllDetails(userId)); // Ensure userId is passed
//                             }}
