...
const MotherForm = ({ initialState = {}, isEdit = false }) => {
  ...
  useEffect(() => {
    if (success) {
      ...
      setTimeout(
        () => navigate(`/layout/paternalGrandfather-form/${userId}`),
        2000
      );
    }
          ...
          >
            ...
            {isEdit ? (
              ...
              <div className="w-full text-end items-end flex justify-end">
                <Link
                  to={`/layout/paternalGrandfather-form/${userId}`}
