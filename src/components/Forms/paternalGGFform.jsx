...
const PaternalGGFform = ({ initialState = {}, isEdit = false }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isEdit && initialState._id) {
      ...
      dispatch(
        createFamilyMember({
          memberType: "paternalGrtGrandFather",
          ...
          >
            ...
            <div className="flex items-center space-x-2 mb-3 w-full justify-center lg:justify-start">
              <input
                ...
                placeholder="Great Grand Fathers name"
              />
            ...
            <div className="w-full flex justify-center lg:justify-start">
              <input
                ...
                placeholder=" Great Grand Fathers last name"
              />
            </div>
            <div className="w-full flex justify-center lg:justify-start">
              <input
...
export default PaternalGGFform;
