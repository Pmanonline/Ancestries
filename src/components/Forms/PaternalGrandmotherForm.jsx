...
const PaternalGrandmotherForm = ({ initialState = {}, isEdit = false }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isEdit && initialState._id) {
      ...
      dispatch(
        createFamilyMember({
          memberType: "paternalGrandMother",
  ...
  useEffect(() => {
    if (success) {
      ...
      setTimeout(
        () => navigate(`/layout/maternalGrandfather-form/${userId}`),
        2000
      );
    }
          ...
          >
            ...
            <div className="flex items-center space-x-2 mb-3 w-full justify-center lg:justify-start">
              <input
                ...
                placeholder="PaternalGrandMothers name"
              />
            ...
            <div className="w-full flex justify-center lg:justify-start">
              <input
                ...
                placeholder="PaternalGrandMothers last name"
              />
            </div>
            <div className="w-full flex justify-center lg:justify-start">
              <input
            ...
            {isEdit ? (
              ...
              <div className="w-full text-end items-end flex justify-end">
                <Link
                  to={`/layout/maternalGrandfather-form/${userId}`}
...
export default PaternalGrandmotherForm;
