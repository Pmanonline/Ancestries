...
const MaternalGrandfatherForm = ({ initialState = {}, isEdit = false }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isEdit && initialState._id) {
      ...
      dispatch(
        createFamilyMember({
          memberType: "maternalGrandFather",
  ...
  useEffect(() => {
    if (success) {
      ...
      setTimeout(
        () => navigate(`/layout/maternalGrandmother-form/${userId}`),
        2000
      );
    }
          ...
          >
            <div className="mb-5">
              <h3 className="text-2xl text-black mb-2">
                {isEdit ? "Edit here" : "Add MaternalGrandFather details"}
              </h3>
              <p className="text-sm">
                Enter information about your maternal grandfather. By including
                his details, you contribute to building a fuller picture of your
                mother's side of the family, enriching your family history
              </p>
            </div>
            <div className="flex items-center space-x-2 mb-3 w-full justify-center lg:justify-start">
              <input
                ...
                placeholder="maternalGrandFathers name"
              />
            ...
            {isEdit ? (
              ...
              <div className="w-full text-end items-end flex justify-end">
                <Link
                  to={`/layout/maternalGrandmother-form/${userId}`}
...
export default MaternalGrandfatherForm;
