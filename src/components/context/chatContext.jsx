...
export const ChatContextProvider = ({ children, user, chat }) => {
  ...
  const fetchChats = useCallback(async () => {
    ...
    try {
      ...
      console.log("Chats with latest messages:", chatsWithLatestMessages);
      setUserChats(chatsWithLatestMessages || []);
    } catch (error) {
    ...
    async (textMessage, sender, currentChatId, setTextMessage) => {
      try {
        ...
        setUserChats((prevChats) => {
          ...
          console.log("Updated chats after new message:", updatedChats);
          return updatedChats;
        });
      } catch (error) {
  ...
  return (
    <ChatContext.Provider
      value={{
        userChats: sortedUserChats, // Provide the sorted chats instead of the unsorted ones
        isUserChatsLoading,
        isUserChatsError,
        potentialChats,
        CreateChat,
